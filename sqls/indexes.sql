...
DROP INDEX IF EXISTS uq_chats_channel_id_video_id_timestamp_usec CASCADE;
...
CREATE UNIQUE INDEX uq_chats_channel_id_video_id_timestamp_usec ON chats(channel_id, video_id, timestamp_usec);
